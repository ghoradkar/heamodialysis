...
class InvetsChartScreen extends StatefulWidget {
  final String? metricName;
  final InvestigationChartReportModel? dates;
  final List<double?> series;

  const InvetsChartScreen({
    super.key,
    this.metricName,
    this.dates,
  ...
  @override
  State<InvetsChartScreen> createState() => _InvetsChartScreenState();
}

class _InvetsChartScreenState extends State<InvetsChartScreen> {
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemCount: controller
                        .investReportModel?.data[widget.metricName]?.length ??
                    0,
                itemBuilder: (context, index) {
                  final entries = controller
                      .investReportModel!.data[widget.metricName]!.entries
                      .toList();
  ...
  Widget _buildTrendChart(PatientController controller) {
    final metricData = controller.investReportModel?.data[widget.metricName];
