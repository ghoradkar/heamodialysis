...
class _PatientHemoglobinScreenState
    extends State<PatientHemoglobinScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        debugPrint('isInitialLoading: $isInitialLoading');
        debugPrint('hasInternet: $hasInternet');
        debugPrint('controller.isLoading: ${patientController.isLoading.value}');
        debugPrint('displayedPatientsVital length: ${patientController.displayedPatientsVital.length}');
        debugPrint('isSearchingVital: ${patientController.isSearchingVital.value}');
        // 1. Initial loading (when first opening screen)
        if (isInitialLoading) {
          debugPrint('Showing initial loading spinner');
          return  Center(
        ...
        debugPrint('Showing patient list with ${patientController.displayedPatientsVital.length} items');
