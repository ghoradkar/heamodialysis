...
import 'package:heamodialysis/nephro_desk_patient_list/edit_nephro/add_edit_inst.dart';
import 'package:heamodialysis/nephro_desk_patient_list/edit_nephro/tabs/inst_table.dart';
        ...
        return Column(
          children: [
            TabBar(
              ...
              tabs: [
                buildTab(0, "Individual Instructions"),
                  ...
                  CustomButton(
                    ...
                    callB: () async {
                      ...
                      if (nephroController.checkboxStates
                        ...
                        await controller.saveInstructions(
                            body,
                            widget.patientData?.treatmentId.toString(),
