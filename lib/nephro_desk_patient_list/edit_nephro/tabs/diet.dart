...
class _DietScreenState extends State<DietScreen> {
  final NephroController nephroController =
  Get.put(NephroController());
            ...
            children: [
              Row(
                ...
                children: [
                  InkWell(
                      onTap: () {
                        Get.to( AddEditDiet(proLiItem: widget.patientData,userData: userData,isEdit: false,));
                      },
                      child:
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return DietCard(
                      ...
                      callB1: (index) async{
                       await  controller.getDietDetailsOnClick(controller
                            .dietList?[index].dietMasterId);
                        Get.to(() => AddEditDiet(
                          userData: userData,
                          proLiItem: widget.patientData,
                          dietDetails: controller
                              .dietList?[index],
                          isEdit: true,
                        ));
                      },
                      callB2: (index)async {
                        await controller.deleteDiet(controller
                            .dietList?[index].dietMasterId, controller
                            .dietList?[index].userId,widget.patientData?.treatmentId);
                      },
                    );
                  },
                ),
