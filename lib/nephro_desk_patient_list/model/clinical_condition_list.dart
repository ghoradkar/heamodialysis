class ClinicalConditionList {
  ClinicalConditionList({
      this.statusCode, 
      this.message, 
      this.data, 
      this.datDiagonosisMasterDtoa, 
      this.departmentId, 
      this.eventBean,});

  ClinicalConditionList.fromJson(dynamic json) {
    statusCode = json['statusCode'];
    message = json['message'];
    data = json['data'];
    if (json['datDiagonosisMasterDtoa'] != null) {
      datDiagonosisMasterDtoa = [];
      json['datDiagonosisMasterDtoa'].forEach((v) {
        datDiagonosisMasterDtoa?.add(DatDiagonosisMasterDtoa.fromJson(v));
      });
    }
    departmentId = json['departmentId'];
    eventBean = json['eventBean'];
  }
  String? statusCode;
  String? message;
  dynamic data;
  List<DatDiagonosisMasterDtoa>? datDiagonosisMasterDtoa;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['message'] = message;
    map['data'] = data;
    if (datDiagonosisMasterDtoa != null) {
      map['datDiagonosisMasterDtoa'] = datDiagonosisMasterDtoa?.map((v) => v.toJson()).toList();
    }
...
class DatDiagonosisMasterDtoa {
  ...
  DatDiagonosisMasterDtoa.fromJson(dynamic json) {
    id = json['id'];
