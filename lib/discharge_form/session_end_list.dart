...
import 'package:heamodialysis/discharge_form/session_end_form_details.dart';
          ...
          builder: (controller) {
            return controller.hasInternet
                ...
                ?  Center(child: buildShimmerLoader())
                    : ListView.builder(
                        itemCount: controller.filteredDialysisEventList != null
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (controller.filteredDialysisEventList != null) {
                            patientData.patientId = controller
                                .filteredDialysisEventList![index].patientId;
                            ...
                            patientData.treatmentId = controller
                                .filteredDialysisEventList![index].treatmentId;
                          } else {
                            patientData.patientId =
                                controller.dischargeList[index].patientId;
                            patientData.centerPatientId =
                                controller.dischargeList[index].centerPatientId;
                            patientData.fName =
                          ...
                          return DischargePatientCardList(
                            patientList: controller.filteredDialysisEventList !=
                                    null
                                ? controller.filteredDialysisEventList![index]
                      ...
                      children: [
                        Expanded(
                          child: patientDetailsCard(
                              cardItemDetailsList[0], patientList.patientId.toString()
                          ),
                        ),
                        Padding(
