...
class VisitPatientDetalis {
  VisitPatientDetalis({
      this.code, 
      this.status, 
      this.data,});

  VisitPatientDetalis.fromJson(dynamic json) {
    code = json['code'];
    status = json['status'];
...
class VisitData {
  ...
  VisitData.fromJson(dynamic json) {
    ...
    transferUnitId = json['transferUnitId'];
    srnId = json['srnId'];
  ...
  String? lastLookupDetIdSchemeAdopt;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['transferUnitId'] = transferUnitId;
    map['srnId'] = srnId;
