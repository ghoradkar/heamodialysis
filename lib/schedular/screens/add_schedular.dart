...
import 'package:heamodialysis/schedular/screens/date_slot_card.dart';
import 'package:heamodialysis/schedular/screens/patient_details_schedular.dart';
...
class _AddSchedularState extends State<AddSchedular> {
  ...
  checkInternetAndLoadData() async {
    ...
    if (hasInternet) {
      ...
      //      .showSearchBy(int.parse(userData['ui'].toString()));
