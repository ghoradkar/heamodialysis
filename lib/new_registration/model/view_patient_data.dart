class ViewPatientData {
  ...
  ViewPatientData.fromJson(dynamic json) {
    ...
    // socialEconomicStatus = json['socialEconomicStatus'];
  ...
  Map<String, dynamic> toJson() {
    ...
    // map['socialEconomicStatus'] = socialEconomicStatus;
