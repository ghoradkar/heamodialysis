...
class _ClusterDistrictWiseDashState extends State<ClusterDistrictWiseDash>
  ...
  //     //     userData['unitId'].toString().toString(), fromDate, fromDate);
  ...
  //     await dashboardController.getChartDataAbhaCluster(fromDate, toDate);
  //
  ...
  //         userData['unitId'].toString().toString(), fromDate, toDate);
  //     dashboardController.isTodaysDate = true;
  //
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: DrawerScreen(
          userType: userType,
          userName: userName,
          userData: userData,packageInfo: dashboardController.packageInfo,
        ),
      ),
