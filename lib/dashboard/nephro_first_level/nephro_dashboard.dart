...
import 'package:heamodialysis/dashboard/nephro_first_level/nephro_patient_reg.dart';
    ...
    return Scaffold(
      ...
      body: GetBuilder<DashboardController>(
          ...
          builder: (controller) {
            ...
            bool? isDVL = controller.deptList?.departments.contains("DVL");
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Visibility(
                                  ...
                                  child: Expanded(
                                    child: DashCard(
                                      ...
                                      firstCount: controller.nephroCounts?.patientAdded
                                          .toString(),
                                      ...
                                      onInfoClick: () {
                                        Get.to(DashInfoTableNephro(
                                          patients:
                                              dashboardController.dashInfoDataNephro ??
                                                  [],
                                ...
                                const VerticalDottedDivider(height: 190, color:Colors.black26, dashHeight: 4, dashWidth: 1,),
                                Visibility(
                                  visible: isDCS == true,
                                      ...
                                      onInfoClick: () {
                                        Get.to(DashInfoTableTotal(
                                          ...
                                          showData: (unitName) async {
                                            ...
                                            Get.to(TotalDialysisPatientId(
                                              patients:
                                                  controller.dialysisPatientIDNephro ??
                                                      [],
                                              pageTitle: 'Dialysis Sessions',
                                            ));
                                          },
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Visibility(
                                    visible: isDVL == true,
                                    child:  DashCard(
                                      title:'New Patient Verification Count',
                                      firstCount: "0",
                                      firstCountText: "Till Date",
                                      secondCount: "0",
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: Visibility(
                                    visible: isDAE == true,
                                    child: DashCard(title: 'Total Event Occured"',
                                      firstCount: controller.nephroCounts?.totalEvent
                                          .toString(),
                                      firstCountText: "Till Date",
                                      secondCount: controller
                                        ...
                                        Get.to(DashInfoTableAdmin(
                                          ...
                                          showPopUp: (unitId) async {
                                            ...
                                            Get.to(DashInfoTableEvent(
                                              patients: controller.nephroEventId ?? [],
                                              pageTitle: 'Total Event Occured',
                                            ));
                                          },
                                        ));
