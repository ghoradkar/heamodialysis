...
class PatientDetailsModel {
  ...
  PatientDetailsModel.fromJson(dynamic json) {
    ...
    if (json['data'] != null) {
      data = [];
      json['data'].forEach((v) {
        data?.add(PatientDataDet.fromJson(v));
      });
    }
...
class PatientDataDet {
  ...
  PatientDataDet.fromJson(dynamic json) {
  ...
  dynamic dialysisEventDetID;
  int? unitId;
  int? patientId;
  dynamic treatmentId;
  dynamic eventDateTime;
  dynamic lookupDetIdIncidentType;
