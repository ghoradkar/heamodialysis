                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    hdChartController.valueController.clear();
                                    Get.back();
                                  },
                                  child: Image.asset(
                                    "assets/cancel.png",
                            ...
                            TextField(
                              controller: hdChartController.valueController,
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      await hdChartController.getHdChartList(
                                        hdChartController.valueController.text,
                                        dropDownValue?.lookupDetValue ?? "",
                                        hdChartController.userData['unitId']
                                            .toString(),
                                      );
                                      Get.back();
                                    },
