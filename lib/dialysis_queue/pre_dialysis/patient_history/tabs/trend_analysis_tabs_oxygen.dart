...
import 'package:heamodialysis/dialysis_queue/pre_dialysis/patient_history/tabs/tabular_analysis_oxygen.dart';
...
class TrendAnalysisTabsOxygen extends StatefulWidget {
  final List<OxygenLevelTrendAnalysisList>? oxygen;
  const TrendAnalysisTabsOxygen({super.key, this.oxygen});

  @override
  State<TrendAnalysisTabsOxygen> createState() =>
      _TrendAnalysisTabsOxygenState();
}

class _TrendAnalysisTabsOxygenState extends State<TrendAnalysisTabsOxygen>
                ...
                Expanded(
                  child: TabBarView(
                    ...
                    children:  [
                      ...
                      TabularAnalysisOxygen(oxygen: widget.oxygen,),
                      GraphicalAnalysisOxygen(oxygen: widget.oxygen,),
                    ],
                  ),
                )
              ],
