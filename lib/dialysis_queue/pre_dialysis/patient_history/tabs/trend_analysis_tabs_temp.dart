...
import 'package:heamodialysis/dialysis_queue/pre_dialysis/patient_history/tabs/graphical_analysis_temp.dart';
import 'package:heamodialysis/dialysis_queue/pre_dialysis/patient_history/tabs/tabular_analysis_temp.dart';
...
class TrendAnalysisTabsTemp extends StatefulWidget {
  final List<TemperatureTrendAnalysisList>? temp;
  const TrendAnalysisTabsTemp({super.key, this.temp});

  @override
  State<TrendAnalysisTabsTemp> createState() =>
      _TrendAnalysisTabsTempState();
}

class _TrendAnalysisTabsTempState extends State<TrendAnalysisTabsTemp>
              ...
              children: [
                ...
                Expanded(
                  child: TabBarView(
                    controller: tabController,
                    children:  [
                      TabularAnalysisTemp(temp: widget.temp,),
                      GraphicalAnalysisTemp(temp: widget.temp,),
                    ],
                  ),
                )
              ],
