...
class GraphicalAnalysisOxygen extends StatefulWidget {
  final List<OxygenLevelTrendAnalysisList>? oxygen;

  const GraphicalAnalysisOxygen({super.key, this.oxygen});

  @override
  State<GraphicalAnalysisOxygen> createState() => _GraphicalAnalysisOxygenState();
}

class _GraphicalAnalysisOxygenState extends State<GraphicalAnalysisOxygen> {
  @override
  Widget build(BuildContext context) {
    ...
    if (widget.oxygen != null) {
      for (var data in widget.oxygen!) {
        ...
        if (data.preDialysisOxygen != null) preDialysisVal.add(double.parse(data.preDialysisOxygen!));
        if (data.preDialysisOxygen != null) postDialysisVal.add(double.parse(data.preDialysisOxygen!));
      }
    }
